...
const Header: React.FC<HeaderProps> = ({ isDarkMode, onDarkModeToggle }) => {
  ...
  return (
    <>
      {/* Announcement Banner */}
      {showAnnouncement && (
        <div className="fixed top-0 left-0 right-0 z-60 bg-gradient-to-r from-primary-orange to-orange-600 text-white py-2 px-4 text-sm text-center">
      ...
      <header className={`${headerClasses} ${showAnnouncement ? 'top-10' : 'top-0'}`} role="banner">
